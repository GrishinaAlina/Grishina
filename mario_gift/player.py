...
ANIMATION_DELAY = 1
ANIMATION_RIGHT = ("levels/r1.png","levels/r2.png","levels/r3.png","levels/r4.png","levels/r5.png",)
ANIMATION_LEFT = ("levels/l1.png","levels/l2.png","levels/l3.png","levels/l4.png","levels/l5.png",)
ANIMATION_JUMP = ("levels/j.png", ANIMATION_DELAY)
ANIMATION_JUMP_l = ("levels/jl.png", ANIMATION_DELAY)
ANIMATION_JUMP_R = ("levels/jr.png", ANIMATION_DELAY)
ANIMATION_JUMP_STAY = ("levels/0.png", ANIMATION_DELAY)
...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.anim_jump_right = pyganim.PygAnimation([ANIMATION_JUMP_R])
        self.anim_jump_right.play()

        self.anim_jump_left = pyganim.PygAnimation([ANIMATION_JUMP_l])
        self.anim_jump_left.play()

        self.anim_stay = pyganim.PygAnimation([ANIMATION_JUMP_STAY])
        self.anim_stay.play()
    ...
    def move(self, event):
        ...
        if event.type == pygame.KEYDOWN and (event.key == pygame.K_w or event.key == pygame.K_SPACE):
            self.up = True
        if event.type == pygame.KEYUP and (event.key == pygame.K_w or event.key == pygame.K_SPACE):
            self.up = False
